export const DUMMYDATA = {
  data: {
    ...
    Menu: [
        ...
        Dishes: [
          {
            ...
            description:
              'Extra butter extra garlic just the way grandma likes it \n',
            inStock: true,
            isVeg: false,
            price: 550,
          },
          ...
          },
          {
            ...
            description:
              'Pita rolls with yum in every bite. Lebanese style chicken, hummus,  hot yogurt sauce & pickled vegetables.\n',
            inStock: true,
            isVeg: false,
            price: 310,
          },
          {
            ...
            description:
              'Oven cooked meatballs with arrabiata & cheddar cheese',
            inStock: true,
            isVeg: false,
            price: 410,
          },
          ...
          },
          {
            ...
            description:
              'The house special fully loaded pizza topped with American corn, onions, olives, bell peppers, jalapeno & sundried tomato\n',
            inStock: true,
            isVeg: true,
            price: 470,
          },
          ...
          },
          {
            ...
            description:
              'The cheesiest pizza of them all cheese & only cheese yellow cheddar, white cheddar, parmesan & mozzarella (add Italian tomato sauce on request)\n',
            inStock: true,
            isVeg: true,
            price: 560,
          },
          ...
          },
          {
            ...
            description:
              'A pizza as Indian as it gets, tandoor cooked chicken, buttery tomato sauce, Kasturi methi & mozzarella cheese\n',
            inStock: true,
            isVeg: false,
            price: 550,
          },
          ...
          },
          {
            ...
            description:
              'Crumbled cottage cheese, caramelised onions, jalapeno, home made mayonnaise, melted cheese & crispy potato straws',
            inStock: true,
            isVeg: true,
            price: 360,
          },
          ...
          },
          {
            ...
            description:
              'Pulled barbecued chicken topped with caramelized onions, jalapenos , home made mayo & crispy potato straws\n',
            inStock: true,
            isVeg: false,
            price: 400,
          },
          {
            ...
            description:
              'Grilled tenderloin patty burger served with tomato relish , caramelized onions, home made mayo & crispy potato straws\n',
            inStock: true,
            isVeg: false,
            price: 520,
          },
          ...
          },
          {
            ...
            description:
              'Gratinated macaroni pasta in a secret super cheesy sauce\n',
            inStock: true,
            isVeg: true,
            price: 425,
          },
          ...
          },
          {
            name: 'Pesto Basilico',
            description:
              'Penne pasta tossed in fresh basil pesto cream sauce with sauteed vegetables\n',
            inStock: true,
            isVeg: true,
            price: 390,
          },
          {
            name: 'Penne Arabiata',
            description:
              'Pasta tossed in Italian tomato sauce fresh basil leaves & vegetables\n',
            inStock: true,
            isVeg: true,
            price: 360,
          },
          {
            ...
            description:
              'Grilled vegetables, cheese sauce, tomato sauce, layered pasta, stringy mozzarella\n',
            inStock: true,
            isVeg: true,
            price: 420,
          },
          {
            ...
            description:
              'Creamy arborio rice cooked with sun dried tomato pesto , cherry tomatoes , fresh basil parmesan & mozzarella cheese\n',
            inStock: true,
            isVeg: true,
            price: 410,
          },
          {
            ...
            description:
              'Rigatoni pasta tossed in a cheesy parmesan, mozzarella, white & yellow cheddar sauce\n',
            inStock: true,
            isVeg: true,
            price: 460,
          },
          {
            ...
            description:
              'Creamy arborio rice cooked shitake , oyster , porcini & button mushroom ragout , fresh basil parmesan & mozzarella cheese\n',
            inStock: true,
            isVeg: true,
            price: 410,
          },
          {
            ...
            description:
              'Basil & garlic marinated grilled chicken served with creamy mash potatoes , sauteed vegetables & red wine jus\n',
            inStock: true,
            isVeg: false,
            price: 490,
          },
          ...
          },
          {
            ...
            description:
              'Paprika & herb rubbed roast chicken served with mash potatoes , buttered vegetables & classic home demi glaze\n',
            inStock: true,
            isVeg: false,
            price: 560,
          },
          {
            ...
            description:
              'Italian comfort food special, succulent chicken meatballs cooked in Italian tomato sauce served over spaghetti\n',
            inStock: true,
            isVeg: false,
            price: 410,
          },
          {
            name: 'Rajma Chawal',
            description:
              'A north Indian home staple topped with green chutney pickle salad & crispy papad',
            inStock: true,
            isVeg: true,
            price: 280,
          },
          {
            ...
            description:
              'Home made punjabi khichidi tempered with garlic, curry leaves & desi ghee, topped with pickle',
            inStock: true,
            isVeg: true,
            price: 210,
          },
          {
            name: 'Keema Pav',
            description:
              'Minced mutton & egg cooked with onion & tomatoes seasoned with Indian spices',
            inStock: true,
            isVeg: false,
            price: 590,
          },
          {
            name: 'Butter Chicken',
            description:
              'The legendary Pritam style butter chicken served with Laccha paratha',
            inStock: true,
            isVeg: false,
            price: 450,
          },
          {
            ...
            description:
              'Homestyle green Thai curry with steam rice & choice addition',
            inStock: true,
            isVeg: true,
            price: 420,
          },
          ...
          },
          {
            ...
            description:
              'Balsamic beet, orange, caramelized walnuts, arugula lettuce, balsamic port wine dressing, feta cheese\n',
            inStock: true,
            isVeg: true,
            price: 340,
          },
          {
            name: 'Greek Salad',
            description:
              'Crunchy iceberg, cherry tomatoes, cucumber, red radish, peppers, Greek feta, olives, lime & maple dressing, toasted sesame\n',
            inStock: true,
            isVeg: true,
            price: 340,
          },
          ...
          },
          {
            ...
            description:
              'Caramelized apples, cinnamon, californian cherries, crip pie,\n',
            inStock: true,
            isVeg: true,
            price: 410,
          },
          {
            ...
            description:
              "Our take on marie biscuit cake. Homemade specula's crumble, five spice caramel",
            inStock: true,
            isVeg: true,
            price: 310,
          },
          ...
          },
          {
            ...
            description:
              'Ultra rich chocolate cake, served with vanilla ice cream',
            inStock: true,
            isVeg: false,
            price: 280,
          },
          {
            name: 'Mud Cake',
            description:
              'Delicious moist & rich, this is definitely the best cake for chocolate lovers, served with vanilla ice cream',
            inStock: true,
            isVeg: false,
            price: 260,
          },
          {
            name: 'Garlic Bread',
            description:
              'Toasted panini bread, overloaded with garlic butter.\n',
            inStock: true,
            isVeg: true,
            price: 190,
          },
          {
            name: 'Masala Fries',
            description:
              "Fried crispy potato finger sprinkled with grandmama's spice mix\n",
            inStock: true,
            isVeg: true,
            price: 210,
          },
      ...
      },
      {
        ...
        Dishes: [
          ...
          },
          {
            name: 'Fiama Pizza',
            description:
              'A spicy pizza with oven roasted onions, chilli flakes & mozzarella cheese\n',
            inStock: true,
            isVeg: true,
            price: 390,
          },
      ...
      },
      {
        ...
        Dishes: [
          ...
          },
          {
            ...
            description:
              'Smoked paprika spiced crispy chicken leg, hot sauce caramelized onion home made mayo & crispy potato straws\n',
            inStock: true,
            isVeg: false,
            price: 410,
          },
      ...
      },
      {
        ...
        Dishes: [
          ...
          {
            name: 'Spring Vegetables Agli E Olio',
            description: "Small Plates by Grandmama's",
            inStock: true,
            isVeg: true,
            price: 180,
    ...
    URL: 'https://www.swiggy.com/restaurants/grandmamas-cafe-iricen-railway-colony-koregaon-park-pune-131042',
  },
};
