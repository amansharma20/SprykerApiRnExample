...
export const CheckCircle = props => (
  <Svg
    ...
    {...props}>
    <Path
      d="m24.875 41.443 19.74-19.74-3.92-3.92-15.82 15.82-7.98-7.98-3.92 3.92 11.9 11.9Zm3.92 15.12c-3.873 0-7.513-.736-10.92-2.207-3.407-1.469-6.37-3.464-8.89-5.983-2.52-2.52-4.515-5.484-5.984-8.89-1.47-3.407-2.206-7.047-2.206-10.92 0-3.874.735-7.514 2.206-10.92 1.47-3.407 3.464-6.37 5.984-8.89 2.52-2.52 5.483-4.516 8.89-5.987C21.282 1.297 24.922.562 28.795.562s7.513.735 10.92 2.204c3.407 1.471 6.37 3.466 8.89 5.986 2.52 2.52 4.515 5.484 5.984 8.89 1.47 3.407 2.206 7.047 2.206 10.92 0 3.874-.736 7.514-2.206 10.92-1.47 3.407-3.464 6.37-5.984 8.89-2.52 2.52-5.483 4.515-8.89 5.984-3.407 1.471-7.047 2.206-10.92 2.206Z"
      fill="#4CA771"
    />
  </Svg>
);
